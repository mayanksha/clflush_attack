...
ax1.set_title("\n".join(wrap("Accuracy (%) vs Number of Cycles waited (sending 60 different characters, total 5000 Bytes)", 50)))
ax1.set_xlabel("Number of Cycles waited before another probe")
ax1.set_ylabel("Accuracy (% of bytes received)")
fig1.savefig('./accuracy_5000.png')

fig2, ax2 = plt.subplots(figsize=(10,8))
ax2.scatter(clocks, bps)
ax2.plot(clocks, bps)
ax2.set_title("\n".join(wrap("Bandwidth vs Number of Cycles waited (sending 60 different characters, total 5000 Bytes)", 50)))
ax2.set_xlabel("Number of Cycles waited before another probe")
ax2.set_ylabel("Bandwidth (Bytes/sec) ")
fig2.savefig('./bandwidth_5000.png')
