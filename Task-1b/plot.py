...
ax1.set_title("\n".join(wrap("Number of bytes received vs Number of Cycles waited (sending file with 34 different characters, total 262 Bytes)", 50)))
ax1.set_xlabel("Number of Cycles waited before another probe")
ax1.set_ylabel("Number of bytes received")
fig1.savefig('./bytes_recvd_50.png')
